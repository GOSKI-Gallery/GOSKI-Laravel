...
@if ($href)
    <a href="{{ $href }}" class="bg-white dark:bg-gray-800 border border-gray-100 dark:border-gray-700 rounded-xl p-6 transition-all hover:shadow-md hover:border-gray-200 dark:hover:border-gray-600 cursor-pointer group">
