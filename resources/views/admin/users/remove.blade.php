...
<div class="w-full max-w-md">
    ...
    <div class="bg-white dark:bg-zinc-950 rounded-xl shadow-sm p-6 border border-gray-100 dark:border-gray-700">
        ...
        <div class="mb-4 p-4 bg-gray-50 dark:bg-zinc-900 rounded-lg border border-gray-100 dark:border-gray-700">
        ...
        <form action="{{ route('admin.users.destroy', $user->id) }}" method="POST">
            ...
            <div class="mb-4">
                ...
                <input type="text" name="username" placeholder="{{ $user->username }}" 
                    class="w-full border border-gray-200 dark:border-gray-700 bg-white dark:bg-zinc-900 rounded-xl px-4 py-3 text-sm outline-none focus:ring-4 focus:ring-red-500/10 focus:border-red-500 transition-all placeholder:text-gray-300 dark:placeholder:text-gray-500 dark:text-gray-200" 
                    required>
                @error('username')
            ...
            <div class="flex gap-3 pt-2">
                <a href="{{ route('admin.users.index') }}" 
                   class="flex-1 bg-gray-50 dark:bg-zinc-900 hover:bg-gray-100 dark:hover:bg-gray-600 text-gray-700 dark:text-gray-300 font-black text-xs uppercase tracking-tight py-3 rounded-xl text-center transition-all cursor-pointer">
                    Cancelar
                </a>
                <button type="submit" 
                        class="flex-1 bg-red-600 hover:bg-red-700 text-white font-black text-xs uppercase tracking-tight py-3 rounded-xl transition-all active:scale-95">
